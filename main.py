    ...
    for tx in data.get("transactions", []):
        if tx.get("type") == "SWAP":
            ...
            if wallet in wallets:
                ...
                # You want to send this alert to **all chat IDs that added wallets?**
                # For now, send to a default chat id set in env var
...
def telegram_webhook():
    ...
    if text.startswith("/addwallet "):
        ...
        send_telegram_message("Unknown command. Use /addwallet <wallet> or /list", chat_id)
